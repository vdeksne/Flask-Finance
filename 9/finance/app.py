...
if request.method == "POST":
    ...
    if not symbol:
        ...
        return apology("ust provide a positive integer number of shares")
    ...
    # Add the purchases to the history
    db.execute(
...
#FIX HERE!!!!!! just un comment the return...
...
def quote():
    ...
    if request.method == "POST":
        ...
        return render_template("quote.thml", quote=quote)
    else:
